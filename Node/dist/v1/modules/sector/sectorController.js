...
const sectorUtils_1 = require("./sectorUtils");
const constants_1 = require("../../../config/constants");
class SectorController {
    constructor() {
        this.sectorUtils = new sectorUtils_1.SectorUtils();
        this.getAllSector = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.sectorUtils.getAllSector();
