...
class CurrencyController {
    constructor() {
        this.currencyUtils = new CurrencyUtils_1.CurrencyUtils();
        this.getAllCurrency = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.currencyUtils.getAllCurrency();
