...
const ServiceCategoryUtils_1 = require("./ServiceCategoryUtils");
const constants_1 = require("../../../config/constants");
class ServiceCategoryController {
    constructor() {
        this.serviceCategoryUtils = new ServiceCategoryUtils_1.ServiceCategoryUtils();
        this.getAllServiceCategory = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.serviceCategoryUtils.getAllServicesCategory();
            if (result) {
