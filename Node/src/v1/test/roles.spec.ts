...
describe("Roles APIs", () => {
  ...
  describe("ADD Roles",  () => {
    ...
    it('Name Field maximum lenght is 50', async () => {
      return request(BASE_URL)
        .post('role')
        .send(
          name_length_data
    ...
    it('Please select rights(Rights must be required)', async () => {
      return request(BASE_URL)
        .post('role')
        .send(
          status_data
  ...
  it('Internal server error', async () => {
    ...
    it('Data updated successfully.....', async () => {
      return request(BASE_URL)
        .put('role/6')
        .send(
          update_data 
  ...
  describe("VIEW Roles Data ",  () => {
    ...
    it('Data get successfully....', async () => {
      return request(BASE_URL)
        .get('role/1')
        .send({        
        })
    ...
    it('Get all data successfully....', async () => {
      return request(BASE_URL)
        .post('role/search')
        .send({        
        })
    ...
    it('Data search with active and inactive status', async () => {
      return request(BASE_URL)
        .post('role/search')
        .send(       
          search_data
  ...
  describe("DELETE Roles",  () => {
    ...
    it('Record(s) already exists for users_test', async () => {
      return request(BASE_URL)
        .delete('role/1')
        .send({        
        })
    ...
    it('Data deleted successfully........', async () => {
      return request(BASE_URL)
        .delete('role/5')
        .send({        
        })
    ...
    it('URL not found for delete many', async () => {
      return request(BASE_URL)
    ...
    it('Id required (empty field not allow)', async () => {
      return request(BASE_URL)
    ...
    it('Record(s) deleted successfully But Record(s) already exists for users_test:-', async () => {
      return request(BASE_URL)
        .post('role/delete-many')
        .send(
          depend_or_not_data      
  ...
  describe("Change Rights data status",  () => {
    ...
    it('Data should not empty', async () => {
      return request(BASE_URL)
        .post('role/toggle-status')
        .send(
          not_empty
    ...
    it('Data should string int not allow', async () => {
      return request(BASE_URL)
        .post('role/toggle-status')
        .send(
          id_string_data
    ...
    it('Status updated successfully But Record(s) already exists for users_test:-', async () => {
      return request(BASE_URL)
        .post('role/toggle-status')
        .send(
          dependant_data
