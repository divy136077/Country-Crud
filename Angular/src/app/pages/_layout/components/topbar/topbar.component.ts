...
import { PersonalInfoListModel } from 'src/app/modules/user-profile/personal-information/model/personal-information.model';
...
export class TopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private layout: LayoutService, private auth: AuthService, private commonService: CommonService) {
