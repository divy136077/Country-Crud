...
export class CountryFormEditComponent {
  ...
  diag() {
    ...
    console.log(this.CountryForm.value);
    this.CountryForm.value.Name ? formData.append('Name', this.CountryForm.value.Name) : null;
    this.CountryForm.value.Code ? formData.append('Code', this.CountryForm.value.Code) : null;
    this.CountryForm.value.active ? formData.append('active', this.CountryForm.value.active) : null;

    this.edit(this.route.snapshot.params['id'], this.CountryForm.value);
